# Building Detection using U-Net (Deep Learning)

## 📌 Overview
This project implements **building detection** from satellite imagery using a **U-Net** deep learning model. The U-Net architecture is widely used for **semantic segmentation** and is well-suited for extracting buildings from high-resolution aerial or satellite images.
